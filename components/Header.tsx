...
<svg version="1.0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024" preserveAspectRatio="xMidYMid meet">
  ...
  <g transform="translate(0,1024) scale(0.1,-0.1)" stroke="none">
    ...
    <path fill="#3730a3" d="M1971 5850 c-208 -62 -399 -205 -498 -375 -31 -52 -43 -65 -63 -65 -50 0 -56 15 -22 55 27 30 32 44 32 86 0 43 -5 55 -29 80 -23 22 -39 29 -69 29 -75 0 -122 -69 -103 -152 10 -42 2 -47 -43 -26 -22 9 -29 8 -46 -7 -21 -19 -21 -19 17 -42 21 -12 58 -25 83 -29 25 -3 55 -15 66 -26 12 -11 41 -25 65 -33 34 -10 43 -17 41 -31 -38 -267 9 -441 167 -616 52 -57 55 -64 88 -191 19 -72 41 -139 50 -149 14 -15 33 -18 122 -18 58 0 111 4 118 8 15 10 33 57 33 88 0 28 0 28 105 9 121 -22 246 -19 397 10 39 7 38 8 52 -57 11 -51 28 -58 141 -58 84 0 107 3 123 18 14 12 30 59 53 151 28 119 36 139 66 169 19 19 48 52 64 75 l30 41 -92 18 c-197 40 -365 129 -519 275 -141 134 -242 291 -299 466 -17 49 -27 67 -40 67 -48 0 -68 75 -28 107 21 16 23 25 19 81 -2 34 -7 62 -10 61 -4 0 -36 -9 -71 -19z m-623 -262 c7 -7 12 -22 12 -34 0 -28 -43 -80 -58 -70 -20 12 -25 65 -8 91 18 27 36 31 54 13z"/>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <div className="flex-shrink-0">
            <img src={logoSrc} alt="PoupaAI Logo" className="h-24 w-auto" />
          </div>
